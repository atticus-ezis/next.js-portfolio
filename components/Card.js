  ...
  return (
    <>
      <div className="w-[320px] h-fit bg-white rounded-xl p-4 flex flex-col items-center">
        ...
        {/* card */}
        <div className="relative w-full rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl group">
          <a className="block" href={`${link}`} target="_blank">
            {/* image */}

            <img className="w-full h-48 object-cover rounded-lg mx-auto" src={`/${image}`} alt={title}></img>
