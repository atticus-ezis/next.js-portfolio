...
const background = [
  "I've been a full-stack software developer for one year. I'm currently studying LLM and AI development to create RAG applications like this one! I can use Python for datascience, numpy, pandas, sci-kit. And Django for full-stack web development.-\
    ...
    Personal details: I was born in 1998. My favorite food is cheeseburgers, my favorite color is green. I make music for fun and I study jazz piano.",
];
    ...
    const response = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: `You are pretending to be Atticus Ezis during a job interview. If the question isn't related to my personal background and professional experience remind the user of your scope and purpose. Use the following context to guide your answers: for general background use:\n\n${background}-\
